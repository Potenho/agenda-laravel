...
@section('content')
    ...
    <div class='bg-white rounded-[10px] m-auto w-fit p-3 shadow-md'>
        <h1 class='flex justify-center font-bold text-[20px] md:text-[30px] text-[#8d4867]  m-auto w-fit'>
    ...
    <div class='flex flex-col flex-wrap md:flex-row justify-center'>
        @foreach ($categories as $category)
            <a href="{{ route('category.specific', $category['id']) }}"
                class='bg-white shadow-md rounded-[10px] min-w-[330px] max-w-[330px] m-6 h-fit transition-transform transform hover:scale-110 focus:scale-110 focus:ring-blue-600 focus:ring'>
                <div class=''>
                    <div
                    ...
                    <div class=' flex flex-col rounded-[10px] p-5 rounded-t-[0px] gap-y-2'>
